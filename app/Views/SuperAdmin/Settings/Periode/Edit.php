...
<h1 class="modal-title fs-5" id="staticBackdropLabel"><i class="ti ti-settings"></i> Edit Periode / TP</h1>
...
<div class="form-floating mb-2">
  <input type="text" name="nm_periode" class="form-control" id="periode" placeholder="Tahun Pelajaran" value="<?=$p['nm_periode']?>">
