...
<form id="form-item-langgar">
    <?=csrf_field();?>
    <input type="hidden" name="item_id" value="<?=$jenis['id']?>">
    <input type="hidden" name="jenis" value="<?=$jenis['jenis_id']?>">
<div class="modal-body">
    <p>
       Jenis / Kategori :  <b><?=$jenis['jenis']?></b>
    </p>
<div class="form-floating mb-2">
  <input type="text" name="nama_pelanggaran" class="form-control" id="item-langgar" value="<?=$jenis['nama_pelanggaran']?>">
  <label for="item-langgar">Nama / Item Pelanggaran</label>
  <div class="invalid-feedback langgar"></div>
</div>
<div class="form-floating">
    <input type="number" name="poin" class="form-control" id="poin-langgar" value="<?=$jenis['poin']?>">
