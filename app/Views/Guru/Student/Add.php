    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary" id="btn-simpan-siswa">Simpan Siswa</button>
        </div>
      </form>
    </div>
  </div>
...
$('#form-siswa').submit(function (e) { 
  ...
  $.ajax({
    type: "post",
    url: "<?=base_url('teacher/student/save')?>",
    data: $(this).serialize(),
    dataType: "json",
        beforeSend: function () {
        ...
        $('#btn-simpan-siswa').html(`Simpan Siswa`);
        },
    success: function (response) {
        ...
        //   window.location= '<?=base_url('teacher/student')?>';
        }
