  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="staticBackdropLabel">Tambah Agenda Pertemuan</h1>
      ...
      <div class="modal-body bg-light">
        <div class="form-group row mb-2">
            ...
            <div class="col-lg-4">
                <input type="number" name="pertemuan" id="pertemuan" class="form-control form-control-sm">
            </div>
            <label for="tgl_pertemuan" class="col-lg-1">Tanggal</label>
            <div class="col-lg-4">
                <input type="date" name="tgl_pertemuan" id="tgl_pertemuan" class="form-control form-control-sm">
            </div>
        </div>
        ...
        <div class="form-group row mb-2">
            ...
            <div class="col-lg-9">
                <textarea id="materi" name="materi" class="form-control" rows="6"></textarea>
            </div>
        </div>
        <div class="form-group row mb-2">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" id="btn-tambahkan" class="btn btn-success"><i class="ti ti-checkbox"></i> Tambahkan</button>
      </div>
      </form>
    </div>
  </div>
...
<script>
  ...
  <span class="visually-hidden" role="status">Loading...</span>`)
        ...
        if (response.status=true) {
            Toastify({
                text: 'Agenda Pertemuan Ditambahkan',
